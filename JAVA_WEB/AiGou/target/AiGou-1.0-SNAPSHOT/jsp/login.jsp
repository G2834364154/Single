...
<form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet?method=login" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">密&nbsp&nbsp&nbsp码</label>
    <div class="col-sm-6">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="inputPassword5" placeholder="请输入验证码">
    </div>
    <div class="col-sm-3">
  ...
  <div class="form-group">
	...
	<div style="margin-top:50px;">
		...
		<div style="text-align: center;margin-top: 5px;margin-bottom:20px;">
			Copyright &copy; 2005-2020 艾购商城 版权所有
		</div>
</body></html>